 ...
 * to use the {@link TEMPERATURE_IR_V2_CALLBACK_AMBIENT_TEMPERATURE} callback and set the period with
 * {@link temperature_ir_v2_set_ambient_temperature_callback_configuration}.
 * 
 * 
 ...
 * to use the {@link TEMPERATURE_IR_V2_CALLBACK_OBJECT_TEMPERATURE} callback and set the period with
 * {@link temperature_ir_v2_set_object_temperature_callback_configuration}.
 * 
 * 
 * If you want to get the value periodically, it is recommended to use the
