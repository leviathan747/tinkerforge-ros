...
#include "tinkerforge/bricklet_can.h"
...
static void can_callback_wrapper_frame_read(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CAN_CALLBACK_FRAME_READ];
...
void can_register_callback(CAN *can, int16_t callback_id, void *function, void *user_data) {
