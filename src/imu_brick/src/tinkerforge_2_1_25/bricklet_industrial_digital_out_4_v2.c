...
static void industrial_digital_out_4_v2_callback_wrapper_monoflop_done(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + INDUSTRIAL_DIGITAL_OUT_4_V2_CALLBACK_MONOFLOP_DONE];
...
void industrial_digital_out_4_v2_register_callback(IndustrialDigitalOut4V2 *industrial_digital_out_4_v2, int16_t callback_id, void *function, void *user_data) {
