...
#include "tinkerforge/bricklet_io16_v2.h"
...
static void io16_v2_callback_wrapper_input_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + IO16_V2_CALLBACK_INPUT_VALUE];
...
static void io16_v2_callback_wrapper_all_input_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + IO16_V2_CALLBACK_ALL_INPUT_VALUE];
...
static void io16_v2_callback_wrapper_monoflop_done(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + IO16_V2_CALLBACK_MONOFLOP_DONE];
...
void io16_v2_register_callback(IO16V2 *io16_v2, int16_t callback_id, void *function, void *user_data) {
