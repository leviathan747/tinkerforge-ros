...
#include "tinkerforge/bricklet_laser_range_finder_v2.h"
...
static void laser_range_finder_v2_callback_wrapper_distance(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + LASER_RANGE_FINDER_V2_CALLBACK_DISTANCE];
...
static void laser_range_finder_v2_callback_wrapper_velocity(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + LASER_RANGE_FINDER_V2_CALLBACK_VELOCITY];
...
void laser_range_finder_v2_register_callback(LaserRangeFinderV2 *laser_range_finder_v2, int16_t callback_id, void *function, void *user_data) {
