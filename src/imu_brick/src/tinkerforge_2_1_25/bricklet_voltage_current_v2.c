...
#include "tinkerforge/bricklet_voltage_current_v2.h"
...
static void voltage_current_v2_callback_wrapper_current(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + VOLTAGE_CURRENT_V2_CALLBACK_CURRENT];
...
static void voltage_current_v2_callback_wrapper_voltage(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + VOLTAGE_CURRENT_V2_CALLBACK_VOLTAGE];
...
static void voltage_current_v2_callback_wrapper_power(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + VOLTAGE_CURRENT_V2_CALLBACK_POWER];
...
void voltage_current_v2_register_callback(VoltageCurrentV2 *voltage_current_v2, int16_t callback_id, void *function, void *user_data) {
