...
#include "tinkerforge/bricklet_distance_ir_v2.h"
...
static void distance_ir_v2_callback_wrapper_distance(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + DISTANCE_IR_V2_CALLBACK_DISTANCE];
...
static void distance_ir_v2_callback_wrapper_analog_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + DISTANCE_IR_V2_CALLBACK_ANALOG_VALUE];
...
void distance_ir_v2_register_callback(DistanceIRV2 *distance_ir_v2, int16_t callback_id, void *function, void *user_data) {
