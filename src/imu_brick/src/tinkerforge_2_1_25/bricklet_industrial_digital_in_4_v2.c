...
static void industrial_digital_in_4_v2_callback_wrapper_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + INDUSTRIAL_DIGITAL_IN_4_V2_CALLBACK_VALUE];
...
static void industrial_digital_in_4_v2_callback_wrapper_all_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + INDUSTRIAL_DIGITAL_IN_4_V2_CALLBACK_ALL_VALUE];
