...
#include "tinkerforge/bricklet_industrial_dual_0_20ma_v2.h"
...
static void industrial_dual_0_20ma_v2_callback_wrapper_current(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + INDUSTRIAL_DUAL_0_20MA_V2_CALLBACK_CURRENT];
