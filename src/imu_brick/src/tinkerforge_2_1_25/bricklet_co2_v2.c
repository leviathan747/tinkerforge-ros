...
#include "tinkerforge/bricklet_co2_v2.h"
...
static void co2_v2_callback_wrapper_all_values(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CO2_V2_CALLBACK_ALL_VALUES];
...
static void co2_v2_callback_wrapper_co2_concentration(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CO2_V2_CALLBACK_CO2_CONCENTRATION];
...
static void co2_v2_callback_wrapper_temperature(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CO2_V2_CALLBACK_TEMPERATURE];
...
static void co2_v2_callback_wrapper_humidity(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CO2_V2_CALLBACK_HUMIDITY];
...
void co2_v2_register_callback(CO2V2 *co2_v2, int16_t callback_id, void *function, void *user_data) {
