...
#include "tinkerforge/bricklet_rotary_encoder_v2.h"
...
static void rotary_encoder_v2_callback_wrapper_count(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + ROTARY_ENCODER_V2_CALLBACK_COUNT];
...
static void rotary_encoder_v2_callback_wrapper_pressed(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + ROTARY_ENCODER_V2_CALLBACK_PRESSED];
...
static void rotary_encoder_v2_callback_wrapper_released(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + ROTARY_ENCODER_V2_CALLBACK_RELEASED];
