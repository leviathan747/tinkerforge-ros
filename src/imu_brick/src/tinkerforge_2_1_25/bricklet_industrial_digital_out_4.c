...
#include "tinkerforge/bricklet_industrial_digital_out_4.h"
...
static void industrial_digital_out_4_callback_wrapper_monoflop_done(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + INDUSTRIAL_DIGITAL_OUT_4_CALLBACK_MONOFLOP_DONE];
