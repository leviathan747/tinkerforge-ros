...
#include "tinkerforge/bricklet_piezo_speaker_v2.h"
...
static void piezo_speaker_v2_callback_wrapper_beep_finished(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + PIEZO_SPEAKER_V2_CALLBACK_BEEP_FINISHED];
...
static void piezo_speaker_v2_callback_wrapper_alarm_finished(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + PIEZO_SPEAKER_V2_CALLBACK_ALARM_FINISHED];
...
void piezo_speaker_v2_register_callback(PiezoSpeakerV2 *piezo_speaker_v2, int16_t callback_id, void *function, void *user_data) {
