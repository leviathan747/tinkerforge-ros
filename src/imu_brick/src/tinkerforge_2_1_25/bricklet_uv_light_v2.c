...
#include "tinkerforge/bricklet_uv_light_v2.h"
...
static void uv_light_v2_callback_wrapper_uva(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + UV_LIGHT_V2_CALLBACK_UVA];
...
static void uv_light_v2_callback_wrapper_uvb(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + UV_LIGHT_V2_CALLBACK_UVB];
...
static void uv_light_v2_callback_wrapper_uvi(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + UV_LIGHT_V2_CALLBACK_UVI];
