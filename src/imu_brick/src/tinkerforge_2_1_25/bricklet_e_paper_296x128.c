...
#include "tinkerforge/bricklet_e_paper_296x128.h"
...
static void e_paper_296x128_callback_wrapper_draw_status(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + E_PAPER_296X128_CALLBACK_DRAW_STATUS];
