...
#include "tinkerforge/bricklet_real_time_clock_v2.h"
...
static void real_time_clock_v2_callback_wrapper_date_time(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + REAL_TIME_CLOCK_V2_CALLBACK_DATE_TIME];
...
static void real_time_clock_v2_callback_wrapper_alarm(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + REAL_TIME_CLOCK_V2_CALLBACK_ALARM];
