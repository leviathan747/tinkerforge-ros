...
#include "tinkerforge/bricklet_hall_effect_v2.h"
...
static void hall_effect_v2_callback_wrapper_magnetic_flux_density(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + HALL_EFFECT_V2_CALLBACK_MAGNETIC_FLUX_DENSITY];
...
static void hall_effect_v2_callback_wrapper_counter(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + HALL_EFFECT_V2_CALLBACK_COUNTER];
...
void hall_effect_v2_register_callback(HallEffectV2 *hall_effect_v2, int16_t callback_id, void *function, void *user_data) {
