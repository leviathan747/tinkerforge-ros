...
#include "tinkerforge/bricklet_dual_button_v2.h"
...
static void dual_button_v2_callback_wrapper_state_changed(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + DUAL_BUTTON_V2_CALLBACK_STATE_CHANGED];
