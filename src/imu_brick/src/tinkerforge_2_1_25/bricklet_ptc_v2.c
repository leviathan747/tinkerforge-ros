...
#include "tinkerforge/bricklet_ptc_v2.h"
...
static void ptc_v2_callback_wrapper_temperature(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + PTC_V2_CALLBACK_TEMPERATURE];
...
static void ptc_v2_callback_wrapper_resistance(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + PTC_V2_CALLBACK_RESISTANCE];
...
static void ptc_v2_callback_wrapper_sensor_connected(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + PTC_V2_CALLBACK_SENSOR_CONNECTED];
...
void ptc_v2_register_callback(PTCV2 *ptc_v2, int16_t callback_id, void *function, void *user_data) {
