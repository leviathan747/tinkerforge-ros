...
#include "tinkerforge/bricklet_io4_v2.h"
...
static void io4_v2_callback_wrapper_input_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + IO4_V2_CALLBACK_INPUT_VALUE];
...
static void io4_v2_callback_wrapper_all_input_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + IO4_V2_CALLBACK_ALL_INPUT_VALUE];
...
static void io4_v2_callback_wrapper_monoflop_done(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + IO4_V2_CALLBACK_MONOFLOP_DONE];
...
void io4_v2_register_callback(IO4V2 *io4_v2, int16_t callback_id, void *function, void *user_data) {
