...
#include "tinkerforge/bricklet_linear_poti.h"
...
static void linear_poti_callback_wrapper_position(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + LINEAR_POTI_CALLBACK_POSITION];
...
static void linear_poti_callback_wrapper_analog_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + LINEAR_POTI_CALLBACK_ANALOG_VALUE];
...
static void linear_poti_callback_wrapper_position_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + LINEAR_POTI_CALLBACK_POSITION_REACHED];
...
static void linear_poti_callback_wrapper_analog_value_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + LINEAR_POTI_CALLBACK_ANALOG_VALUE_REACHED];
