...
#include "tinkerforge/bricklet_ambient_light_v3.h"
...
static void ambient_light_v3_callback_wrapper_illuminance(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + AMBIENT_LIGHT_V3_CALLBACK_ILLUMINANCE];
...
void ambient_light_v3_register_callback(AmbientLightV3 *ambient_light_v3, int16_t callback_id, void *function, void *user_data) {
