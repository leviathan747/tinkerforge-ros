...
#include "tinkerforge/bricklet_industrial_dual_analog_in_v2.h"
...
static void industrial_dual_analog_in_v2_callback_wrapper_voltage(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + INDUSTRIAL_DUAL_ANALOG_IN_V2_CALLBACK_VOLTAGE];
...
void industrial_dual_analog_in_v2_register_callback(IndustrialDualAnalogInV2 *industrial_dual_analog_in_v2, int16_t callback_id, void *function, void *user_data) {
