...
#include "tinkerforge/bricklet_lcd_16x2.h"
...
static void lcd_16x2_callback_wrapper_button_pressed(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + LCD_16X2_CALLBACK_BUTTON_PRESSED];
...
static void lcd_16x2_callback_wrapper_button_released(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + LCD_16X2_CALLBACK_BUTTON_RELEASED];
...
void lcd_16x2_register_callback(LCD16x2 *lcd_16x2, int16_t callback_id, void *function, void *user_data) {
