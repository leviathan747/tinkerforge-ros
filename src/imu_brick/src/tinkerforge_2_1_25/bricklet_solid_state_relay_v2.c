...
#include "tinkerforge/bricklet_solid_state_relay_v2.h"
...
static void solid_state_relay_v2_callback_wrapper_monoflop_done(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + SOLID_STATE_RELAY_V2_CALLBACK_MONOFLOP_DONE];
...
void solid_state_relay_v2_register_callback(SolidStateRelayV2 *solid_state_relay_v2, int16_t callback_id, void *function, void *user_data) {
