...
#include "tinkerforge/bricklet_thermocouple_v2.h"
...
static void thermocouple_v2_callback_wrapper_temperature(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + THERMOCOUPLE_V2_CALLBACK_TEMPERATURE];
...
static void thermocouple_v2_callback_wrapper_error_state(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + THERMOCOUPLE_V2_CALLBACK_ERROR_STATE];
