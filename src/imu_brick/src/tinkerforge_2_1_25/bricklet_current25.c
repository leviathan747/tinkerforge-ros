...
#include "tinkerforge/bricklet_current25.h"
...
static void current25_callback_wrapper_current(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_CURRENT];
...
static void current25_callback_wrapper_analog_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_ANALOG_VALUE];
...
static void current25_callback_wrapper_current_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_CURRENT_REACHED];
...
static void current25_callback_wrapper_analog_value_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_ANALOG_VALUE_REACHED];
...
static void current25_callback_wrapper_over_current(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_OVER_CURRENT];
...
void current25_register_callback(Current25 *current25, int16_t callback_id, void *function, void *user_data) {
