...
#include "tinkerforge/bricklet_thermocouple.h"
...
static void thermocouple_callback_wrapper_temperature(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + THERMOCOUPLE_CALLBACK_TEMPERATURE];
...
static void thermocouple_callback_wrapper_temperature_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + THERMOCOUPLE_CALLBACK_TEMPERATURE_REACHED];
...
static void thermocouple_callback_wrapper_error_state(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + THERMOCOUPLE_CALLBACK_ERROR_STATE];
