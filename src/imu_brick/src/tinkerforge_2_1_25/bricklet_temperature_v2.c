...
#include "tinkerforge/bricklet_temperature_v2.h"
...
static void temperature_v2_callback_wrapper_temperature(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + TEMPERATURE_V2_CALLBACK_TEMPERATURE];
...
void temperature_v2_register_callback(TemperatureV2 *temperature_v2, int16_t callback_id, void *function, void *user_data) {
