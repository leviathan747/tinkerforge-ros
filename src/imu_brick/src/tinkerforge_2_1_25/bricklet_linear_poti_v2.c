...
#include "tinkerforge/bricklet_linear_poti_v2.h"
...
static void linear_poti_v2_callback_wrapper_position(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + LINEAR_POTI_V2_CALLBACK_POSITION];
...
void linear_poti_v2_register_callback(LinearPotiV2 *linear_poti_v2, int16_t callback_id, void *function, void *user_data) {
