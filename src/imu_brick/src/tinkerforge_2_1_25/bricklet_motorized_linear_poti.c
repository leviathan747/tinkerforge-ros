...
#include "tinkerforge/bricklet_motorized_linear_poti.h"
...
static void motorized_linear_poti_callback_wrapper_position(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + MOTORIZED_LINEAR_POTI_CALLBACK_POSITION];
...
static void motorized_linear_poti_callback_wrapper_position_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + MOTORIZED_LINEAR_POTI_CALLBACK_POSITION_REACHED];
...
void motorized_linear_poti_register_callback(MotorizedLinearPoti *motorized_linear_poti, int16_t callback_id, void *function, void *user_data) {
