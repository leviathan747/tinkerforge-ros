...
static void nfc_callback_wrapper_reader_state_changed(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + NFC_CALLBACK_READER_STATE_CHANGED];
...
static void nfc_callback_wrapper_cardemu_state_changed(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + NFC_CALLBACK_CARDEMU_STATE_CHANGED];
...
static void nfc_callback_wrapper_p2p_state_changed(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + NFC_CALLBACK_P2P_STATE_CHANGED];
...
void nfc_register_callback(NFC *nfc, int16_t callback_id, void *function, void *user_data) {
