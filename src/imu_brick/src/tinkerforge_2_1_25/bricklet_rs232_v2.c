...
#include "tinkerforge/bricklet_rs232_v2.h"
...
static void rs232_v2_callback_wrapper_read(DevicePrivate *device_p, uint16_t message_length, uint16_t message_chunk_offset, char message_chunk_data[60]) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS232_V2_CALLBACK_READ];
...
static void rs232_v2_callback_wrapper_read_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS232_V2_CALLBACK_READ_LOW_LEVEL];
...
static void rs232_v2_callback_wrapper_error_count(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS232_V2_CALLBACK_ERROR_COUNT];
...
void rs232_v2_register_callback(RS232V2 *rs232_v2, int16_t callback_id, void *function, void *user_data) {
