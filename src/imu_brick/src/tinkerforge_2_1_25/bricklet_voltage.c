...
#include "tinkerforge/bricklet_voltage.h"
...
static void voltage_callback_wrapper_voltage(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + VOLTAGE_CALLBACK_VOLTAGE];
...
static void voltage_callback_wrapper_analog_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + VOLTAGE_CALLBACK_ANALOG_VALUE];
...
static void voltage_callback_wrapper_voltage_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + VOLTAGE_CALLBACK_VOLTAGE_REACHED];
...
static void voltage_callback_wrapper_analog_value_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + VOLTAGE_CALLBACK_ANALOG_VALUE_REACHED];
