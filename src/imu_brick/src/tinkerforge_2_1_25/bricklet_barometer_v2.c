...
#include "tinkerforge/bricklet_barometer_v2.h"
...
static void barometer_v2_callback_wrapper_air_pressure(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + BAROMETER_V2_CALLBACK_AIR_PRESSURE];
...
static void barometer_v2_callback_wrapper_altitude(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + BAROMETER_V2_CALLBACK_ALTITUDE];
...
static void barometer_v2_callback_wrapper_temperature(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + BAROMETER_V2_CALLBACK_TEMPERATURE];
