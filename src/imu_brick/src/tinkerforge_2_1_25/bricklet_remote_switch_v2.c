...
#include "tinkerforge/bricklet_remote_switch_v2.h"
...
static void remote_switch_v2_callback_wrapper_switching_done(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + REMOTE_SWITCH_V2_CALLBACK_SWITCHING_DONE];
...
static void remote_switch_v2_callback_wrapper_remote_status_a(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + REMOTE_SWITCH_V2_CALLBACK_REMOTE_STATUS_A];
...
static void remote_switch_v2_callback_wrapper_remote_status_b(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + REMOTE_SWITCH_V2_CALLBACK_REMOTE_STATUS_B];
...
static void remote_switch_v2_callback_wrapper_remote_status_c(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + REMOTE_SWITCH_V2_CALLBACK_REMOTE_STATUS_C];
