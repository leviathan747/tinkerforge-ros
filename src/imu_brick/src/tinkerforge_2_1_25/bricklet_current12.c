...
#include "tinkerforge/bricklet_current12.h"
...
static void current12_callback_wrapper_current(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT12_CALLBACK_CURRENT];
...
static void current12_callback_wrapper_analog_value(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT12_CALLBACK_ANALOG_VALUE];
...
static void current12_callback_wrapper_current_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT12_CALLBACK_CURRENT_REACHED];
...
static void current12_callback_wrapper_analog_value_reached(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT12_CALLBACK_ANALOG_VALUE_REACHED];
...
static void current12_callback_wrapper_over_current(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + CURRENT12_CALLBACK_OVER_CURRENT];
...
void current12_register_callback(Current12 *current12, int16_t callback_id, void *function, void *user_data) {
