...
#include "tinkerforge/bricklet_segment_display_4x7_v2.h"
...
static void segment_display_4x7_v2_callback_wrapper_counter_finished(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + SEGMENT_DISPLAY_4X7_V2_CALLBACK_COUNTER_FINISHED];
...
void segment_display_4x7_v2_register_callback(SegmentDisplay4x7V2 *segment_display_4x7_v2, int16_t callback_id, void *function, void *user_data) {
