...
#include "tinkerforge/bricklet_rs485.h"
...
static void rs485_callback_wrapper_read(DevicePrivate *device_p, uint16_t message_length, uint16_t message_chunk_offset, char message_chunk_data[60]) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_READ];
...
static void rs485_callback_wrapper_modbus_master_read_coils_response(DevicePrivate *device_p, uint8_t request_id, int8_t exception_code, uint16_t coils_length, uint16_t coils_chunk_offset, bool coils_chunk_data[464]) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_COILS_RESPONSE];
...
static void rs485_callback_wrapper_modbus_master_read_holding_registers_response(DevicePrivate *device_p, uint8_t request_id, int8_t exception_code, uint16_t holding_registers_length, uint16_t holding_registers_chunk_offset, uint16_t holding_registers_chunk_data[29]) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_HOLDING_REGISTERS_RESPONSE];
...
static void rs485_callback_wrapper_modbus_slave_write_multiple_coils_request(DevicePrivate *device_p, uint8_t request_id, uint32_t starting_address, uint16_t coils_length, uint16_t coils_chunk_offset, bool coils_chunk_data[440]) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_MULTIPLE_COILS_REQUEST];
...
static void rs485_callback_wrapper_modbus_slave_write_multiple_registers_request(DevicePrivate *device_p, uint8_t request_id, uint32_t starting_address, uint16_t registers_length, uint16_t registers_chunk_offset, uint16_t registers_chunk_data[27]) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_MULTIPLE_REGISTERS_REQUEST];
...
static void rs485_callback_wrapper_modbus_master_read_discrete_inputs_response(DevicePrivate *device_p, uint8_t request_id, int8_t exception_code, uint16_t discrete_inputs_length, uint16_t discrete_inputs_chunk_offset, bool discrete_inputs_chunk_data[464]) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_DISCRETE_INPUTS_RESPONSE];
...
static void rs485_callback_wrapper_modbus_master_read_input_registers_response(DevicePrivate *device_p, uint8_t request_id, int8_t exception_code, uint16_t input_registers_length, uint16_t input_registers_chunk_offset, uint16_t input_registers_chunk_data[29]) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_INPUT_REGISTERS_RESPONSE];
...
static void rs485_callback_wrapper_read_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_READ_LOW_LEVEL];
...
static void rs485_callback_wrapper_error_count(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_ERROR_COUNT];
...
static void rs485_callback_wrapper_modbus_slave_read_coils_request(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_READ_COILS_REQUEST];
...
static void rs485_callback_wrapper_modbus_master_read_coils_response_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_COILS_RESPONSE_LOW_LEVEL];
...
static void rs485_callback_wrapper_modbus_slave_read_holding_registers_request(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_READ_HOLDING_REGISTERS_REQUEST];
...
static void rs485_callback_wrapper_modbus_master_read_holding_registers_response_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_HOLDING_REGISTERS_RESPONSE_LOW_LEVEL];
	...
	for (i = 0; i < 29; i++) callback->holding_registers_chunk_data[i] = leconvert_uint16_from(callback->holding_registers_chunk_data[i]);

	rs485_callback_wrapper_modbus_master_read_holding_registers_response(device_p, callback->request_id, callback->exception_code, callback->holding_registers_length, callback->holding_registers_chunk_offset, callback->holding_registers_chunk_data);

	if (callback_function != NULL) {
		callback_function(callback->request_id, callback->exception_code, callback->holding_registers_length, callback->holding_registers_chunk_offset, callback->holding_registers_chunk_data, user_data);
	}
}
...
static void rs485_callback_wrapper_modbus_slave_write_single_coil_request(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_SINGLE_COIL_REQUEST];
...
static void rs485_callback_wrapper_modbus_master_write_single_coil_response(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_WRITE_SINGLE_COIL_RESPONSE];
...
static void rs485_callback_wrapper_modbus_slave_write_single_register_request(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_SINGLE_REGISTER_REQUEST];
...
static void rs485_callback_wrapper_modbus_master_write_single_register_response(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_WRITE_SINGLE_REGISTER_RESPONSE];
...
static void rs485_callback_wrapper_modbus_slave_write_multiple_coils_request_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_MULTIPLE_COILS_REQUEST_LOW_LEVEL];
...
static void rs485_callback_wrapper_modbus_master_write_multiple_coils_response(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_WRITE_MULTIPLE_COILS_RESPONSE];
...
static void rs485_callback_wrapper_modbus_slave_write_multiple_registers_request_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_MULTIPLE_REGISTERS_REQUEST_LOW_LEVEL];
	...
	for (i = 0; i < 27; i++) callback->registers_chunk_data[i] = leconvert_uint16_from(callback->registers_chunk_data[i]);

	rs485_callback_wrapper_modbus_slave_write_multiple_registers_request(device_p, callback->request_id, callback->starting_address, callback->registers_length, callback->registers_chunk_offset, callback->registers_chunk_data);

	if (callback_function != NULL) {
		callback_function(callback->request_id, callback->starting_address, callback->registers_length, callback->registers_chunk_offset, callback->registers_chunk_data, user_data);
	}
}
...
static void rs485_callback_wrapper_modbus_master_write_multiple_registers_response(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_WRITE_MULTIPLE_REGISTERS_RESPONSE];
...
static void rs485_callback_wrapper_modbus_slave_read_discrete_inputs_request(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_READ_DISCRETE_INPUTS_REQUEST];
...
static void rs485_callback_wrapper_modbus_master_read_discrete_inputs_response_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_DISCRETE_INPUTS_RESPONSE_LOW_LEVEL];
...
static void rs485_callback_wrapper_modbus_slave_read_input_registers_request(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_READ_INPUT_REGISTERS_REQUEST];
...
static void rs485_callback_wrapper_modbus_master_read_input_registers_response_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	*(void **)(&callback_function) = device_p->registered_callbacks[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_INPUT_REGISTERS_RESPONSE_LOW_LEVEL];
	...
	for (i = 0; i < 29; i++) callback->input_registers_chunk_data[i] = leconvert_uint16_from(callback->input_registers_chunk_data[i]);

	rs485_callback_wrapper_modbus_master_read_input_registers_response(device_p, callback->request_id, callback->exception_code, callback->input_registers_length, callback->input_registers_chunk_offset, callback->input_registers_chunk_data);

	if (callback_function != NULL) {
		callback_function(callback->request_id, callback->exception_code, callback->input_registers_length, callback->input_registers_chunk_offset, callback->input_registers_chunk_data, user_data);
	}
}
